...
RUN tar xzf apache-tomcat-7.0.55.tar.gz /apache-tomcat-7.0.55/conf/
ADD LoginJSP.war apache-tomcat-7.0.55/webapps/ && tomcat-users.xml apache-tomcat-7.0.55/conf/
